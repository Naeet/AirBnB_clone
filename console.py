...
class HBNBCommand(cmd.Cmd):
    ...
    def emptyline(self):
        """
        do ntn when empty line is entered
        """
        pass
    ...
    def do_create(self, arg):
        """
        create new insance of basemodel and save it to json file
        """
    ...
    def default(self, arg):
        """
        default for cmd when the input is invalid
        """
        arg_list = arg.split('.')
